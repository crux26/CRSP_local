/*libname gtx 'C:\Users\dtayl\Desktop\gtx\SAS';*/
/*options ps=3000 ls=150; */
...
%MACRO clus2OLS(data, out, yvar, xvars, cluster1, cluster2);
    options nonotes nosource;
    ods listing close;
    ods exclude all;
    ods graphics off;
	/* do interesection cluster*/
	proc surveyreg data=&data; cluster &cluster1 &cluster2; model &yvar= &xvars /  covb; ods output CovB = CovI; quit;
	/* Do first cluster */
	proc surveyreg data=&data; cluster &cluster1; model &yvar= &xvars /  covb; ods output CovB = Cov1; quit;
	/* Do second cluster */
	proc surveyreg data=&data; cluster &cluster2; model &yvar= &xvars /  covb; ods output CovB = Cov2 ParameterEstimates = params;	quit;
...
/*%clus2OLS(data=ds, out=clus2OLS , yvar=dependentvariable, xvars=listofindependentvariables, cluster1=gvkey, cluster2=fyear);*/
