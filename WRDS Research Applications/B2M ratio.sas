...
%let begdate=01jan1962; %let enddate=31dec2010;
%let comp=mysas; 
%let crsp=mysas;
...
data mysas.comp_extract2/view=mysas.comp_extract2; set &comp..funda;
...
data mysas.indadjmb; merge mysas.bm_comp_crsp mysas.medians;
  by calyear ffi&ind._desc;
