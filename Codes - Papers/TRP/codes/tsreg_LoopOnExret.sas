%macro tsreg_LoopOnExret(RegkeyVar=, out=);
    ...
    %TRP_tsreg_exret_VaR(data=T_tmp_Wed, exret=&exret., RegkeyVar=&RegkeyVar.,
    ...
    proc sql;
        drop table tsreg_exret_lead1W_&RegkeyVar., tsreg_exret_lead2W_&RegkeyVar., tsreg_exret_lead3W_&RegkeyVar.,
